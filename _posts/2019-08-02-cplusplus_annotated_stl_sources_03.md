...
![STL算法总览01](../img/2019-08-02-16-13-21.png)

![STL算法总览02](../img/2019-08-02-16-14-40.png)

![STL算法总览03](../img/2019-08-02-16-18-06.png)

![STL算法总览04](../img/2019-08-02-16-18-57.png)
...
![set_union分析](../img/2019-08-02-21-52-12.png)

#### 6.5.2 set_intersection构造交集

基本上就是上面的条件判断反过来了，当相等时迭代器才增加。

![set_intersection步进分析](../img/2019-08-02-22-08-15.png)

#### 6.5.3 set_difference

![set_difference步进分析](../img/2019-08-02-22-12-26.png)

#### 6.5.4 set_symmetric_difference 构造对称差集

![set_symmetric_difference](../img/2019-08-02-22-14-24.png)